...
<html>
  ...
  <div class="flex items-center border-b border-teal-500 py-2 ">
   ...
   <a href="mailto:albinmelazhakathu@gmail.com"><button class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="button">
    ...
    <button class="flex-shrink-0 bg-gray-700 hover:bg-gray-600 border-teal-500 hover:border-teal-700 text-sm text-white text-sm py-1 px-2 rounded-full mx-3" type="button">
...
<div class="bg-gray-200 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
    ...
    <img class="text-center mx-auto w-auto h-auto" src="<?= htmlentities($result); ?>">
      ...
      <div class="text-center m-2">
		...
		<a href="<?= htmlentities($result); ?>"><button class="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 ml-2 text-sm rounded">View</button></a>
